...
void SortTestResult(T arr[], int n, int sort)
{
  ...
  if (sort == SELECTION)
  {
		cout << ", comparisons = " << SelectionSort(arr, n) << endl;
  ...
  {
    cout << ", comparisons = " << Quicksort(arr, n) << endl;
		  for (int i = 0; i < n; i++)
	  {
		cout << arr[i] << ", ";
	  }
  ...
  {
    cout << ", comparisons = " << RQuicksort(arr, n) << endl;
			  for (int i = 0; i < n; i++)
	  {
		cout << arr[i] << ", ";
	  }
  ...
  {
    cout << ", comparisons = " << Mergesort(arr, n) << endl;
	for (int i = 0; i < n; i++)
	{
		cout << arr[i] << ", ";
	}
  ...
  {
    cout << ", comparisons = " << ShellSort(arr, n) << endl;
